...
- App made with front-end Create React App, Router, and withRouter
- Uses of backend systems such as Express, NPM, and Node.JS
- Initializing and utilizing Sequelize/CLI and SQLite
- Requests made using a Rest Api.
...
- Setting a server using Cross-Origin Resource Sharing (CORS)
- Hashing passwords
- Implementing User authenication on front-end and back-end. 
